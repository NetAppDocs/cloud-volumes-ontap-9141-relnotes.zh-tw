...
9.14.1 P14 補丁現已可供所有雲端供應商的Cloud Volumes ONTAP使用。控制台將提示您將現有系統升級到此補丁版本。

https://mysupport.netapp.com/site/products/all/details/cloud-volumes-ontap/downloads-tab/download/62632/9.14.1P14["查看 P14 補丁修復的錯誤列表"^]（需要登入NetApp支援站點）。
